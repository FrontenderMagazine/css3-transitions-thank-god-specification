...
которая используется для расчёта значения свойства** во время `t`. Есть 
...
поддерживать анимированные переходы. Этот список содержит свойства из CSS2.1. Для 
...
[CSS2 generated content][21]. Если вы не знакомы с генерируемым содержимым, 
